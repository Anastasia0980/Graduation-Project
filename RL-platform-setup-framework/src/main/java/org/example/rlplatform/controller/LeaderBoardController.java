...
public class LeaderBoardController {
    ...
    @GetMapping("/assignments/{assignmentId}/team-leaderboard")
    public Result<Page<LeaderBoard>> listTeam(
            @PathVariable Integer assignmentId,
            @RequestParam(defaultValue = "0") Integer pageNum,
            @RequestParam(defaultValue = "10") Integer pageSize
    ) {
        return Result.success(leaderBoardService.listTeam(assignmentId, pageNum, pageSize));
    }
}
